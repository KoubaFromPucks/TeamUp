import { db } from "@/db";
import { EventInvitationInsertEntity, EventInvitationSelectEntity, EventInvitationUpdateEntity } from "./schema";
import { eventInvitationTable } from "@/db/schema/event-invitation";
import { eq } from "drizzle-orm";

export const eventInvitationRepository = {
    async createEventInvitation(eventInvitationEntity: EventInvitationInsertEntity){
    ...
    async updateEventInvitationById(eventInvitationId: string, eventInvitationEntity: EventInvitationUpdateEntity){
