import { db } from "@/db";
import { ConcreteEventInsertEntity, ConcreteEventSelectEntity, ConcreteEventUpdateEntity } from "./schema";
...
export const concreteEventRepository = {
    ...
    async updateConcreteEventById(concreteEventId: string, concreteEventEntity: ConcreteEventUpdateEntity){
