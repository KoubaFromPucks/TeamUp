...
export const ConcreteEventMapper = {
	...
	mapConcreteEventListModelToDto(
		model: ConcreteEventListModel
	): ConcreteEventListDto {
		return {
			id: model.id,
			endDate: model.endDate,
	...
	mapDtoToConcreteEventInsertModel(
		dto: ConcreteEventUpdateDto
	): ConcreteEventInsertModel {
		return {
			endDate: dto.endDate,
